...
export default class Column {
	// The cols are the contexts.
	// They will share the Flyweights via the FlyweightsFactory.
	// `data`, `width`, and `justify` are extrinsic values outside the flyweights.
	...
	getData(): string {
		// Get the flyweight value from the factory, and apply extrinsic values
		const codes = []
